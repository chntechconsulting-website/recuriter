...
export const DISTRICT_METADATA = [
  ...
  { siNo: 3, district: 'Ariyalur', priority: 'High', assignedTo: 'Karthikeyan' },
  ...
  { siNo: 8, district: 'Ramanathapuram', priority: 'High', assignedTo: 'Rithika' },
  ...
  { siNo: 11, district: 'Dharmapuri', priority: 'High', assignedTo: 'Mohanapriya' },
  ...
  { siNo: 18, district: 'Thanjavur', priority: 'High', assignedTo: 'Karthikeyan' },
  ...
  { siNo: 23, district: 'Krishnagiri', priority: 'Medium', assignedTo: 'Sakthivel' },
  ...
  { siNo: 28, district: 'Nilgiris', priority: 'Medium', assignedTo: 'Sakthivel' },
  ...
  { siNo: 33, district: 'Kanchipuram', priority: 'Low', assignedTo: 'Mohanapriya' },
  ...
  { siNo: 38, district: 'Chennai', priority: 'Low', assignedTo: 'Rithika' }
];
